 ...
 *
 */
public class TurnAbsDegrees2 extends Command {

	double heading, power;
	boolean turnLeft;

	public TurnAbsDegrees2(double heading, double power, boolean turnLeft) {
	...
	protected void initialize() {
		...
		if (Math.abs(360 - this.heading) + Math.abs(angle) < 180) {
			power *= direction ? 1 : -1;
		} else {
			power *= !direction ? 1 : -1;
		}
